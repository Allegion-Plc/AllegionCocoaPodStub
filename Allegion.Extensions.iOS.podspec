#
# Be sure to run `pod lib lint Allegion.Extensions.iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    s.name                    = 'Allegion.Extensions.iOS'
    s.version                 = '0.0.0'
    s.summary                 = 'Allegion.Extensions.iOS is a library that provides common Extensions for objects.'
