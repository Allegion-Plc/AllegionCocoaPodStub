#
# Be sure to run `pod lib lint Allegion.DeepLink.iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    s.name                    = 'Allegion.DeepLink.iOS'
    s.version                 = '0.0.0'
    s.summary                 = 'Allegion.DeepLink.iOS is a library that provides a centralized class for Handling Universal links.'
