#
# Be sure to run `pod lib lint AllegionSecurity.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    s.name                    = 'AllegionSecurity'
    s.version                 = '0.0.0'
    s.summary                 = 'AllegionSecurity is a library that provides data encryption and decryption.'
