#
# Be sure to run `pod lib lint AllegionBLECore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    ...
    s.version                 = '0.0.0'
    s.summary                 = 'AllegionBLECore allows for scanning, connection, and data transfer with remote Allegion Bluetooth peripherals.'
