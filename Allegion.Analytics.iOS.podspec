#
# Be sure to run `pod lib lint Allegion.Analytics.iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    s.name                    = 'Allegion.Analytics.iOS'
    s.version                 = '0.0.0'
    s.summary                 = 'Allegion.Analytics.iOS is a library that provides a centralized class for collecting analytics data.'
