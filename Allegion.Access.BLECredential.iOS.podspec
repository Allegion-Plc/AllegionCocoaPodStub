#
# Be sure to run `pod lib lint Allegion.Access.BLECredential.iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    s.name                    = 'Allegion.Access.BLECredential.iOS'
    s.version                 = '0.0.0'
    s.summary                 = 'Allegion.Access.BLECredential.iOS is a library that provides the ability to send BLE credentials to Allegion devices.'
